...
Using the ANOVA function in R, we find a p-value which is less than 0.05. With that, we reject the hypothesis that the sentiment score of a tweet cannot be predicted by knowing which celebrity the tweet pertains to.
